        ...
        return this.each(function () {
            ...
            if (!this.grid) {
                ...
                var
                    ...
                    o = l(m, "highlight", !0), p = l(m, "hover", !0), q = l(m, "cornerall", !0),
                    r = l(m, "icon_base", !0), s = $.jgrid.styleUI[e.p.styleUI || "jQueryUI"].colmenu,
                    t = $.jgrid.msie(), u = [], v = [], w = [];
                ...
                var
                    y, z = ["shiftKey", "altKey", "ctrlKey"], A = function (a, b) {
                        ...
                        var
                            ...
                            i = e.p.xmlReader, j = "local" === e.p.datatype ? "local" : "xml";
                        if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            var
                                k, n, o, p, q, r, s, t, u, v = $(e), w = 0, x = !0 === e.p.multiselect ? 1 : 0, y = 0,
                                z = !0 === e.p.rownumbers ? 1 : 0, B = [], C = {}, D = [],
                            ...
                            var
                                N, O = L.length, P = 0, Q = [], R = parseInt(e.p.rowNum, 10),
                                S = e.p.scroll ? $.jgrid.randId() : 1, T = $(e).find("tbody:first"), U = !1;
                        ...
                        if (a) {
                            ...
                            var
                                k, n, p, q, r, s, t, u, v, w, x, y = $(e), z = 0, B = [], C = e.p.multiselect ? 1 : 0,
                                D = !0 === e.p.subGrid ? 1 : 0, K = !0 === e.p.rownumbers ? 1 : 0, L = I(C + D + K),
                                N = H(h), O = {}, P = [], Q = l(m, "rowBox", !0, "jqgrow ui-row-" + e.p.direction);
                            ...
                            var
                                V, W = $.isFunction(e.p.afterInsertRow), X = [], Y = !1, Z = $(e).find("tbody:first"),
                        ...
                        if ($.isArray(e.p.data)) {
                            ...
                            var
                                w = s.select(), x = parseInt(e.p.rowNum, 10), y = w.length, z = parseInt(e.p.page, 10),
                                A = Math.ceil(y / x), B = {};
                        ...
                        var
                            c, d, f, g, h, i, j, k, o = "", q = e.p.pager ? $.jgrid.jqID(e.p.pager.substr(1)) : "",
                            r = q ? "_" + q : "", s = e.p.toppager ? "_" + e.p.toppager.substr(1) : "";
                        ...
                        var
                            c, d, f, g, h, j, k,
                            o = "<td class='ui-pg-button " + n + "'><span class='ui-separator'></span></td>", q = "",
                        ...
                        var
                            a, b, c, d, g = 0, h = $.jgrid.cell_width ? 0 : A(e.p.cellLayout, 0), i = 0,
                            j = A(e.p.scrollOffset, 0), k = !1, l = 0;
                        ...
                        var
                            f, g, h, i, j, k = e.p.colModel[a], l = "", m = "", n = "", o = "", q = "", r = "",
                ...
                var
                    ja, ka, la, ma, na, oa, pa, qa, ra, sa = "<thead><tr class='ui-jqgrid-labels' role='row'>", ta = "",
                    ua = "", va = "";
                        ...
                        if ("A" !== na.tagName && ("INPUT" !== na.tagName && "TEXTAREA" !== na.tagName && "OPTION" !== na.tagName && "SELECT" !== na.tagName || c)) if (Ha = oa[0].id, na = $(na).closest("tr.jqgrow>td"), na.length > 0 && (Ia = $.jgrid.getCellIndex(na)), !0 !== e.p.cellEdit) {
                            if (na.length > 0 && (Ja = $(na).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ha, Ia, Ja, a)), d) if (e.p.multimail && e.p.multiselect) {
                                if (a.shiftKey) {
                                    if (c) {
                                        var
                                            g = $(e).jqGrid("getGridParam", "selrow"), h = $(e).jqGrid("getInd", Ha),
                ...
                var
                    ...
                    n = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + c.p.direction), o = function (b) {
                        ...
                        return c.length > 0 ? c[0] : void
                            0
                    }, p = !1, q = !1, r = !!c.p.frozenColumns && c.p.id + "_frozen",
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        ...
                        f = b[c.p.localReader.id], g = a(c).triggerHandler("jqGridBeforeExpandTreeGridRow", [f, b, d]);
                    void
        ...
        exportToCsv: function (b) {
            ...
            if (this.each(function () {
                    ...
                    d(b, c) {
                        ...
                        var
                            f = "", g = j.p.groupingView, h = [], i = g.groupField.length, k = j.p.colModel,
                            l = k.length, m = 0;
                    ...
                    RegExp(b.quote, "g");
                    var
                        e, f, g, h, i, j = this, k = this.addLocalData(!0), l = k.length, m = j.p.colModel,
                        n = m.length, o = j.p.colNames, p = 0, q = "", r = "", s = "", t = "", u = "", v = [], w = [],
                        x = [], y = [];
